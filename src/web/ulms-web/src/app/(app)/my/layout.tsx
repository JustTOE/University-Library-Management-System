...
const NAV = [
  { href: "/my/loans", label: "Loans" },
  { href: "/my/reservations", label: "Reservations" },
  { href: "/my/fines", label: "Fines" },
...
export default async function MyLayout({
  ...
  const path = hdrs.get("x-current-path") ?? "/my/loans";
  await requireRole(path, "STUDENT");
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground">
          Loans, reservations, fines, and notifications for your account.
        </p>
      </div>
      <nav
